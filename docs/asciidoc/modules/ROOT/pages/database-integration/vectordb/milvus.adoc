...
|===
| Operation | Time (ms)
| apoc.vectordb.milvus.createCollection | 51
| apoc.vectordb.milvus.upsert | 335
| apoc.vectordb.milvus.get | 3331
| apoc.vectordb.milvus.query | 302
| apoc.vectordb.milvus.delete | 36
| apoc.vectordb.milvus.deleteCollection | 43
| ...
|===