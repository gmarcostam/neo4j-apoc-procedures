...
The table below shows the time spent on all operations on a sample of 40.000 records.

.Performance results
[opts="header"]
|===
| Operation | Time (ms)
| apoc.vectordb.chroma.createCollection | 38
| apoc.vectordb.chroma.upsert | 7845
| apoc.vectordb.chroma.get | 1056
| apoc.vectordb.chroma.query | 53
| apoc.vectordb.chroma.delete | 29
| apoc.vectordb.chroma.deleteCollection | 113
| ...
|===