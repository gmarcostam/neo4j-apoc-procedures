...
|===
| Operation | Time (ms)
| apoc.vectordb.chroma.createCollection | 40
| apoc.vectordb.chroma.upsert | 8050
| apoc.vectordb.chroma.get | 1156
| apoc.vectordb.chroma.query | 633
| apoc.vectordb.chroma.delete | 32
| apoc.vectordb.chroma.deleteCollection | 136
| ...
|===