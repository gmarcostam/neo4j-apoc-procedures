...
The table below shows the time spent on all operations on a sample of 10.000 records.

.Performance results
[opts="header"]
|===
| Operation | Time (ms)
| apoc.vectordb.weaviate.createCollection | 57
| apoc.vectordb.weaviate.upsert | 31356
| apoc.vectordb.weaviate.get | 3117
| apoc.vectordb.weaviate.query | 245
| apoc.vectordb.weaviate.delete | 4220
| apoc.vectordb.weaviate.deleteCollection | 69
| ...
|===