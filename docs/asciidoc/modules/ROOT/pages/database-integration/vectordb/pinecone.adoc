...
// TODO - cambiare collection con index dove serve, sia in @Description che nella documentazione qui
...
// TODO - mettere questo blocco [NOTE] sopra la stringa `Here is a list of all available Pinecone procedures:`
[NOTE]
====
