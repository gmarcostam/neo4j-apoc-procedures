...
include::producer-configuration.adoc[]

== Serializers

To allow insertion of keys in any format (e.g. through `apoc.kafka.publish` procedure)
...
[source,json]
----
include::ROOT:partial$producer-data/node.updated.json[]
----

[source,json]
----
include::ROOT:partial$producer-data/relationship.updated.json[]
----
...
[source,json]
----
include::ROOT:partial$producer-data/node.deleted.json[]
----

[source,json]
----
include::ROOT:partial$producer-data/relationship.deleted.json[]
----
