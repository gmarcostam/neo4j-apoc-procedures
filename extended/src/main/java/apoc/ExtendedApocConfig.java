...
public class ExtendedApocConfig extends LifecycleAdapter
{
    ...
    private static final String SOURCE_ENABLED = "streams.source.enabled";
    private static final boolean SOURCE_ENABLED_VALUE = true;
    private static final String PROCEDURES_ENABLED = "streams.procedures.enabled";
    private static final boolean PROCEDURES_ENABLED_VALUE = true;
    private static final String SINK_ENABLED = "streams.sink.enabled";
    private static final boolean SINK_ENABLED_VALUE = false;
    private static final String CHECK_APOC_TIMEOUT = "streams.check.apoc.timeout";
    private static final String CHECK_APOC_INTERVAL = "streams.check.apoc.interval";
    private static final String CLUSTER_ONLY = "streams.cluster.only";
    private static final String CHECK_WRITEABLE_INSTANCE_INTERVAL = "streams.check.writeable.instance.interval";
    private static final String SYSTEM_DB_WAIT_TIMEOUT = "streams.systemdb.wait.timeout";
    private static final long SYSTEM_DB_WAIT_TIMEOUT_VALUE = 10000L;
    private static final String POLL_INTERVAL = "streams.sink.poll.interval";
    private static final String INSTANCE_WAIT_TIMEOUT = "streams.wait.timeout";
