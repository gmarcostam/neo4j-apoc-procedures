...
//        var countNodes = db.executeTransactionally(cypherCountNodes, emptyMap()) { it.columnAs<Long>("count").next() }
...
//
//        // create another node
//        countNodes = db.executeTransactionally(cypherCountNodes, emptyMap()) { it.columnAs<Long>("count").next() }
