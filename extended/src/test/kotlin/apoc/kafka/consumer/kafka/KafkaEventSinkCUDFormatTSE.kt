...
//            val hasFooBar = db.executeTransactionally("""
//                MATCH (n:Foo:Bar)
...
//            }
//            val hasFooBarLabel = db.executeTransactionally("""
...
//        // then
//        Assert.assertEventually(ThrowingSupplier {
//            val fooBar = db.executeTransactionally("""
//                MATCH (n:Foo:Bar)
//                WHERE n.key > 5
//                RETURN n.key AS key
//            """.trimIndent(), emptyMap()
...
//        }, Matchers.equalTo(true), 30, TimeUnit.SECONDS)
//        Assert.assertEventually(ThrowingSupplier {
//            val ids = db.executeTransactionally("""
//                        MATCH (:Foo:Bar)-[r:$rel_type]->(:FooBar)
//                        RETURN r.id AS id
//                    """.trimIndent(), emptyMap()
//            ) {
